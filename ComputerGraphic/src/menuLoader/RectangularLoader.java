...
public class RectangularLoader{
	protected Drawer drawer;
	protected ColorPicker colorPicker;
	protected VBox contentBox;
	
	public RectangularLoader(VBox content_box,Drawer drawer, ColorPicker color_picker) {
		this.drawer=drawer;
...
//		drawer.draw(new Line(new Point(-70,-70),new Point(70,70),Color.ALICEBLUE));
